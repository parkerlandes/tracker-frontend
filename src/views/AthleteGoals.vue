<template>
      ...
      <v-container class="pa-8 mt-10">
        ...
        <v-dialog v-model="addDialog" max-width="600">
          <v-card class="pa-6">
            ...
            <v-text-field v-model="newGoal.title" label="Goal Title" class="mb-4" />
        ...
        <v-dialog v-model="editDialog" max-width="600">
          <v-card class="pa-6">
            ...
            <v-text-field v-model="editGoal.title" label="Goal Title" class="mb-4" />
            ...
            <v-text-field v-model="editGoal.playerTime" type="number" label="Target Time" class="mb-4" />
            <v-text-field v-model="editGoal.playerReps" type="number" label="Target Reps" class="mb-4" />
  ...
  const saveEditedGoal = async () => {
    try {
      await goalServices.updateGoal(editGoal.value.id_player_goal, editGoal.value);
